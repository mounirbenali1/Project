...
chartOptions = {
  ...
  title: {
      text: 'GeorgeFloydMurder Sentiment Analytics'
  },
  tooltip: {
...
loadDataSentiment1() 
{  
  this.dashboardService.getSentiment1().valueChanges.pipe(map((result:any) => result.data)).subscribe((data)=>
  {
    this.Tweets=data.GeorgeSen;
